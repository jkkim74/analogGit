...
(function() {
  ...
  */
  ...
  pivotTableRenderer = function(pivotData, opts) {
    ...
    console.log('pivotTableRenderer...');
    ...
    console.log('result');
    console.log(result);
//    $(".pvtTable tr.head-group").css('position', 'fixed');
  ...
  */
  ...
  $.fn.pivot = function(input, opts) {
      ...
      console.log('$.fn.pivot = function(input, opts)');
      console.log(input);
      console.log(opts);
  ...
  */
  ...
  $.fn.pivotUI = function(input, inputOpts, overwrite) {
    ...
    try {
      ...
      uiTable = $("<table class='cookatrice' cellpadding='5'>");
