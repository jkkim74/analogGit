function gifticonCtrl($scope, apiSvc, bmDashboardSvc, $timeout, MAX_EWMA_SIZE) {

    $scope.init = function () {

        $scope.searchDateType = 30;
        $scope.searchStartDate = bmDashboardSvc.getDashboardDefaultCal($scope.searchDateType,2).startDate;
        $scope.searchEndDate = bmDashboardSvc.getDashboardDefaultCal($scope.searchDateType,2).endDate;
