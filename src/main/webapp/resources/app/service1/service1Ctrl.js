function service1Ctrl($scope, $stateParams, $http, API_BASE_URL) {
    ...
    $scope.salesUsersConfig = {
        url: '/salesUser/list?startDate=20101023000000&endDate=20141023999999',
        id: 'jqGridSalesUsers',
        datatype: "json",
        height: 250,
        rowNum: 10000,
        rowList: [10,20,30],
        colNames:['id','username','fullname','생년월일','성별'],
        colModel:[
            {name:'id',index:'id', editable: true, width:60, sorttype:"int", search:true},
            {name:'username',index:'username', editable: true, width:90},
            {name:'fullName',index:'fullName', editable: true, width:100},
            {name:'birthDate',index:'birthDate', editable: true, width:80, sorttype:"date", formatter:"date"},
            {name:'sex',index:'sex', editable: true, width:80, align:"right", sorttype:"float"}
        ],
        pager: "#jqGridPager01",
        viewrecords: true,
        add: true,
    ...
    $scope.init = function() {
        $http.get(API_BASE_URL+'/salesUser/sexCount').then(function(result){
            $scope.salesUserSexCount = result.data;
        });
    };
     ...
     */
    $scope.initBulletChart = function() {
