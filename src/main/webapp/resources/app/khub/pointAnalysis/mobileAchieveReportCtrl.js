...
function mobileAchieveReportCtrl($scope, DATE_TYPE_DAY, reportSvc, apiSvc) {
            ...
            rawData,
            {
                ...
                onRefresh: function () {
                    var config = {
                        ...
                        simpleColMerge: [{row: 1, start: 1, end: 2}],
    ...
    function drawPivot() {
        ...
        $scope.pivotTableId = 'mobileAchieveReportPivot';
        ...
        var httpConfig = {
            url: '/ocb/khub/pointAnalysis/mobileAchieveReport/pivot',
            params: {
    ...
    $scope.excelConfig = {
        ...
        downloadType: 'POI',
        pivotFlag: 'Y',
        tableId: 'mobileAchieveReportPivot',
        titleName: '모바일실적 보고서',
        xlsName: 'mobileAchieve-point-report.xls'
    };
}
