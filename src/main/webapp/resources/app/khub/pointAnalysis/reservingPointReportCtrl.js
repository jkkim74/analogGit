...
function reservingPointReportCtrl($scope, DATE_TYPE_DAY, reportSvc, apiSvc) {
    ...
    function drawPivot() {
        ...
        $scope.pivotTableId = 'reservingPointReportPivot';
        ...
        var httpConfig = {
            url: '/ocb/khub/pointAnalysis/reservingPointReport/pivot',
            params: {
    ...
    $scope.excelConfig = {
        ...
        downloadType: 'POI',
        pivotFlag: 'Y',
        tableId: 'reservingPointReportPivot',
        titleName: '적립포인트 보고서',
        xlsName: 'reserving-point-report.xls'
    };
}
