...
function usePointReportCtrl($scope, DATE_TYPE_DAY, reportSvc, apiSvc) {
    $scope.init = function () {
    ...
    function drawPivot() {
        ...
        $scope.pivotTableId = 'usePointReportPivot';
        ...
        var httpConfig = {
            url: '/ocb/khub/pointAnalysis/usePointReport/pivot',
            params: {
    ...
    $scope.excelConfig = {
        ...
        downloadType: 'POI',
        pivotFlag: 'Y',
        tableId: 'usePointReportPivot',
        titleName: '사용포인트 보고서',
        xlsName: 'use-point-report.xls'
    };
}
