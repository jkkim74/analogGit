function visitLangCtrl($scope, DATE_TYPE_DAY, reportSvc, apiSvc) {
    $scope.init = function () {
    ...
    function drawPivot() {
        ...
        $scope.pivotTableId = 'visitorsLangGrid';
    ...
    $scope.excelConfig = {
        ...
        downloadType: 'POI',
        pivotFlag: 'Y',
        tableId: 'visitorsLangGrid',
        titleName: '방문자(언어)',
        xlsName: 'visitor-lang.xls'
    };
}
