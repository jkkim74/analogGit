/**
 * Created by ophelisis on 2015. 5. 12..
 */
function appSticknessCtrl($scope, DATE_TYPE_DAY, reportSvc, apiSvc, userSvc) {
    $scope.init = function () {
    ...
    function drawPivot() {
        ...
        $scope.pivotTableId = 'appSticknessPivot';
        ...
        var httpConfig = {
            url: '/ocb/customer/appStickness/pivot',
            params: {
    ...
    $scope.search = function(result) {
        if (result.searchDateType != "day" && !apiSvc.getComeRoleUser(userSvc.getUser().username, 9)) {
	...
	$scope.excelConfig = {
        ...
        downloadType : 'POI',
        pivotFlag : 'Y',
        tableId : 'appSticknessPivot',
        titleName : 'App Stickiness(KPI 기준)',
        xlsName : 'app-stickiness.xls'
	};
}
