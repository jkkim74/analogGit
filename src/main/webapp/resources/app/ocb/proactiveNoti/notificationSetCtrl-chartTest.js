...
function notificationSetCtrl($scope, API_BASE_URL, DATE_TYPE_DAY, reportSvc, apiSvc) {
    ...
    function setHighChartConfig(rawData) {
        ...
        $scope.highChartConfig = {
            ...
            rawData: rawData,
            extraOption: {
                customOrder: 2,     //default : 0(cut length)
                legendArea : 150,   //default : 200(chart right margin)
    ...
    function drawPivot() {
        ...
        $scope.pivotTableId = 'notificationSetPivot';
        ...
        var httpConfig = {
            url: '/ocb/proactiveNoti/notificationSet/pivot',
            params: {
                dateType: $scope.searchDateType,
