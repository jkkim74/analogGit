...
function syrupDauCtrl($scope, DATE_TYPE_DAY, reportSvc, apiSvc) {
    ...
    function drawPivot() {
        ...
        $scope.pivotTableId = 'syrupDauPivot';
        ...
        var httpConfig = {
            url: '/ocb/customer/syrupDau/pivot',
            params: {
	...
	$scope.excelConfig = {
        ...
        downloadType : 'POI',
        pivotFlag : 'Y',
        tableId : 'syrupDauPivot',
        titleName : 'SYRUP DAU(KPI 기준)',
        xlsName : 'syrup-dau.xls'
	};
}
