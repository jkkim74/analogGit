...
function safeBackUpCtrl($scope, DATE_TYPE_DAY, reportSvc, apiSvc) {
    ...
    function drawPivot() {
        ...
        $scope.pivotTableId ='safeBackUpPivot';
    ...
    $scope.excelConfig = {
        ...
        downloadType: 'POI',
        pivotFlag: 'Y',
        tableId: 'safeBackUpPivot',
        titleName: '안심백업 보고서',
        xlsName: 'safeBackUpReport.xls'
    };
}
