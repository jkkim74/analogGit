d3.sankey = function() {
  ...
  function computeNodeDepths(iterations) {
    ...
    function customOrderDepth(a, b) {
      ...
      //console.log('a-name : ' + a.name + ' / '+ a.dy );
      //console.log('b-name : ' + b.name + ' / '+ b.dy );
      //console.log('calculate : 1.' + (a.dy- b.dy)+ ' /  2.'+ (b.dy- a.dy));

      //console.log('a.name:' + a.name + ' / b.name:' + b.name);
      //console.log('calculate : ' + a.dy + '-' + b.dy + '=' + (a.dy - b.dy));
  ...
  function center(node) {
    ...
    return 0; //20150825 cookatrice, fix for node sort to make order.
  }
