/* angularjs-nvd3-directives-custom.js
 *
 * 2014-12-12 cookatrice
 *
 **/
( function () {
    'use strict';
                        ...
                        if ( data ) {
                            ...
                            nv.addGraph( {
                                generate: function () {
                                    ...
                                    console.log('angularjs-nvd3-directives-custom.js');
                                    ...
                                    var chart = nv.models.stackedAreaChart().width( scope.width ).height( scope.height ).margin( scope.margin ).x( attrs.x === undefined ? function ( d ) {
                                        //var chart = nv.models.stackedAreaChart().width( scope.width ).margin( scope.margin ).x( attrs.x === undefined ? function ( d ) {
                                        return d[ 0 ];
                                    } : scope.x() ).y( attrs.y === undefined ? function ( d ) {
                                        return d[ 1 ];
                                    ...
                                    console.log('don not touch..!!');
                                    //$('svg').css('height',scope.margin);
                                    //console.log(chart);
