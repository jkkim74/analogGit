var RadarChart = {
  draw: function(id, d, options){
    ...
    //cfg.w = parseInt(d3.select(id).style("width")) - 20;
    //cfg.h = cfg.w;
    ...
    function resizeChart() {
      ...
      if (fitScreen) {
          ...
          g.attr("width", windowSize.width);
          g.attr("height", windowSize.height);
      } else {
          // resize based on container's width
          var aspect = cfg.w / cfg.h;
          //console.log(aspect);
          var targetWidth = parseInt(d3.select(id).style("width")) - 20;
          console.log(targetWidth);
          g.attr("width", targetWidth);
          g.attr("height", Math.round(targetWidth / aspect));
      }
    };
  }
};
