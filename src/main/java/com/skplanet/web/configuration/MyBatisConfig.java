...
public class MyBatisConfig {
	...
	public MapperScannerConfigurer mysqlMapperScannerConfigurer() {
		...
		configurer.setBasePackage("com.skplanet.web.repository.mysql");
	...
	public MapperScannerConfigurer oracleMapperScannerConfigurer() {
		...
		configurer.setBasePackage(
				"com.skplanet.web.repository.oracle;com.skplanet.ctas.repository.oracle;com.skplanet.pandora.repository.oracle");
