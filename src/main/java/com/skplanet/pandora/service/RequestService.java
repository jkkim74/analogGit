		...
		CsvCreatorTemplate<AutoMappedMap> csvCreator = new CsvCreatorTemplate<AutoMappedMap>() {
			...
			protected void printRecord(CSVPrinter printer, AutoMappedMap map) throws IOException {
				...
				if ((uploadProgress.getPageId()).equals("pan0101")) {
					...
					if (map.get("mbrId"                 ) == null) {dataList.add(" ");} else {dataList.add(map.get("mbrId"                 ).toString());}
					if (map.get("unitedId"              ) == null) {dataList.add(" ");} else {dataList.add(map.get("unitedId"              ).toString());}
					if (map.get("gndr"                  ) == null) {dataList.add(" ");} else {dataList.add(map.get("gndr"                  ).toString());}
					if (map.get("age"                   ) == null) {dataList.add(" ");} else {dataList.add(map.get("age"                   ).toString());}			
					if (map.get("homeHjdLgrp"           ) == null) {dataList.add(" ");} else {dataList.add(map.get("homeHjdLgrp"           ).toString());}
					if (map.get("homeHjdMgrp"           ) == null) {dataList.add(" ");} else {dataList.add(map.get("homeHjdMgrp"           ).toString());}
					if (map.get("jobpHjdLgrp"           ) == null) {dataList.add(" ");} else {dataList.add(map.get("jobpHjdLgrp"           ).toString());}
					if (map.get("jobpHjdMgrp"           ) == null) {dataList.add(" ");} else {dataList.add(map.get("jobpHjdMgrp"           ).toString());}
					if (map.get("mrrgYn"                ) == null) {dataList.add(" ");} else {dataList.add(map.get("mrrgYn"                ).toString());}
					if (map.get("ocbMktngAgrmtYn"       ) == null) {dataList.add(" ");} else {dataList.add(map.get("ocbMktngAgrmtYn"       ).toString());}
					if (map.get("emailRcvAgrmtYn"       ) == null) {dataList.add(" ");} else {dataList.add(map.get("emailRcvAgrmtYn"       ).toString());}
					if (map.get("advtSmsRcvAgrmtYn"     ) == null) {dataList.add(" ");} else {dataList.add(map.get("advtSmsRcvAgrmtYn"     ).toString());}
					if (map.get("ifrmtSmsRcvAgrmtYn"    ) == null) {dataList.add(" ");} else {dataList.add(map.get("ifrmtSmsRcvAgrmtYn"    ).toString());}
					if (map.get("pushRcvAgrmtYn"        ) == null) {dataList.add(" ");} else {dataList.add(map.get("pushRcvAgrmtYn"        ).toString());}
					if (map.get("bnftMlfPushAgrmtYn"    ) == null) {dataList.add(" ");} else {dataList.add(map.get("bnftMlfPushAgrmtYn"    ).toString());}
					if (map.get("pntUseRsvngPushAgrmtYn") == null) {dataList.add(" ");} else {dataList.add(map.get("pntUseRsvngPushAgrmtYn").toString());}
					if (map.get("tusePushAgrmtYn"       ) == null) {dataList.add(" ");} else {dataList.add(map.get("tusePushAgrmtYn"       ).toString());}
					if (map.get("coinNotiPushAgrmtYn"   ) == null) {dataList.add(" ");} else {dataList.add(map.get("coinNotiPushAgrmtYn"   ).toString());}
					if (map.get("locUtlzAgrmtYn"        ) == null) {dataList.add(" ");} else {dataList.add(map.get("locUtlzAgrmtYn"        ).toString());}
					if (map.get("mlfShpAgrmtYn"         ) == null) {dataList.add(" ");} else {dataList.add(map.get("mlfShpAgrmtYn"         ).toString());}
					if (map.get("mlfTrdareaAgrmtYn"     ) == null) {dataList.add(" ");} else {dataList.add(map.get("mlfTrdareaAgrmtYn"     ).toString());}
					if (map.get("ocbcomJoinYn"          ) == null) {dataList.add(" ");} else {dataList.add(map.get("ocbcomJoinYn"          ).toString());}
					if (map.get("ocbAppJoinYn"          ) == null) {dataList.add(" ");} else {dataList.add(map.get("ocbAppJoinYn"          ).toString());}
					if (map.get("ocbPlusJoinYn"         ) == null) {dataList.add(" ");} else {dataList.add(map.get("ocbPlusJoinYn"         ).toString());}
					if (map.get("seg629Cd"              ) == null) {dataList.add(" ");} else {dataList.add(map.get("seg629Cd"              ).toString());}
					if (map.get("trfcSegCd"             ) == null) {dataList.add(" ");} else {dataList.add(map.get("trfcSegCd"             ).toString());}
					if (map.get("ocbcomMth07FnlLgnDt"   ) == null) {dataList.add(" ");} else {dataList.add(map.get("ocbcomMth07FnlLgnDt"   ).toString());}
					if (map.get("ocbAppMth07FnlUseDt"   ) == null) {dataList.add(" ");} else {dataList.add(map.get("ocbAppMth07FnlUseDt"   ).toString());}						
					if (map.get("appAtdcMth07FnlUseDt"  ) == null) {dataList.add(" ");} else {dataList.add(map.get("appAtdcMth07FnlUseDt"  ).toString());}
					if (map.get("rletMth07FnlUseDt"     ) == null) {dataList.add(" ");} else {dataList.add(map.get("rletMth07FnlUseDt"     ).toString());}
					if (map.get("gameMth07FnlUseDt"     ) == null) {dataList.add(" ");} else {dataList.add(map.get("gameMth07FnlUseDt"     ).toString());}
					if (map.get("ocbPlusMth07FnlYachvDt") == null) {dataList.add(" ");} else {dataList.add(map.get("ocbPlusMth07FnlYachvDt").toString());}
					if (map.get("lckrMth07FnlYachvDt"   ) == null) {dataList.add(" ");} else {dataList.add(map.get("lckrMth07FnlYachvDt"   ).toString());}
					if (map.get("mzmMth07FnlYachvDt"    ) == null) {dataList.add(" ");} else {dataList.add(map.get("mzmMth07FnlYachvDt"    ).toString());}
					if (map.get("azmMth07FnlYachvDt"    ) == null) {dataList.add(" ");} else {dataList.add(map.get("azmMth07FnlYachvDt"    ).toString());}
					if (map.get("prdLflMth07FnlYachvDt" ) == null) {dataList.add(" ");} else {dataList.add(map.get("prdLflMth07FnlYachvDt" ).toString());}
					if (map.get("mblCardPossYn"         ) == null) {dataList.add(" ");} else {dataList.add(map.get("mblCardPossYn"         ).toString());}
					if (map.get("skpCardPossYn"         ) == null) {dataList.add(" ");} else {dataList.add(map.get("skpCardPossYn"         ).toString());}
					if (map.get("crdtCardPossYn"        ) == null) {dataList.add(" ");} else {dataList.add(map.get("crdtCardPossYn"        ).toString());}
					if (map.get("chkcrdPossYn"          ) == null) {dataList.add(" ");} else {dataList.add(map.get("chkcrdPossYn"          ).toString());}
					if (map.get("cmncnCardPossYn"       ) == null) {dataList.add(" ");} else {dataList.add(map.get("cmncnCardPossYn"       ).toString());}
					if (map.get("encleanBnsCardPossYn"  ) == null) {dataList.add(" ");} else {dataList.add(map.get("encleanBnsCardPossYn"  ).toString());}
					if (map.get("freiWlfrCardPossYn"    ) == null) {dataList.add(" ");} else {dataList.add(map.get("freiWlfrCardPossYn"    ).toString());}
					if (map.get("rflExcsCardPossYn"     ) == null) {dataList.add(" ");} else {dataList.add(map.get("rflExcsCardPossYn"     ).toString());}				
					if (map.get("rflMth07FnlYachvDt"    ) == null) {dataList.add(" ");} else {dataList.add(map.get("rflMth07FnlYachvDt"    ).toString());}
					if (map.get("cmncnMth07FnlYachvDt"  ) == null) {dataList.add(" ");} else {dataList.add(map.get("cmncnMth07FnlYachvDt"  ).toString());}
					if (map.get("fncMth07FnlYachvDt"    ) == null) {dataList.add(" ");} else {dataList.add(map.get("fncMth07FnlYachvDt"    ).toString());}
					if (map.get("etcMth07FnlYachvDt"    ) == null) {dataList.add(" ");} else {dataList.add(map.get("etcMth07FnlYachvDt"    ).toString());}
					if (map.get("onlnMth07FnlYachvDt"   ) == null) {dataList.add(" ");} else {dataList.add(map.get("onlnMth07FnlYachvDt"   ).toString());}
					if (map.get("onlnMth07CpnFnlYachvDt") == null) {dataList.add(" ");} else {dataList.add(map.get("onlnMth07CpnFnlYachvDt").toString());}
					if (map.get("avlPnt"                ) == null) {dataList.add(" ");} else {dataList.add(map.get("avlPnt"                ).toString());}					
					if (map.get("rnum"                  ) == null) {dataList.add(" ");} else {dataList.add(map.get("rnum"                  ).toString());}
