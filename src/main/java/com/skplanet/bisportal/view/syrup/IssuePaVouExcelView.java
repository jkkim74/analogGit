 ...
 */
public class IssuePaVouExcelView extends AbstractExcelView {
	@Override
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		String menuName = "멤버십 발급 상세_결제,상품권";
		...
		// 엑셀 바디 생성.
		List<SmwCardIssueDtl> smwDCardIssueDtlList = uncheckedCast(model.get("issuePaVouExcelViewData"));
