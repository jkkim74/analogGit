...
/**
 * Created by pepsi on 2014. 4. 28..
 */
@Data
public class Pagination implements Serializable {

	private static final long serialVersionUID = 3958749167884674883L;
	/**
	 * Required Fields - 이 필드들은 페이징 계산을 위해 반드시 입력되어야 하는 필드 값들이다.
	 * 
	 * currentPageNo : 현재 페이지 번호 recordCountPerPage : 한 페이지당 게시되는 게시물 건 수 pageSize : 페이지 리스트에 게시되는 페이지 건수,
	 ...
	 * 
	 * totalPageCount: 페이지 개수 firstPageNoOnPageList : 페이지 리스트의 첫 페이지 번호 lastPageNoOnPageList : 페이지 리스트의 마지막 페이지 번호
	 * firstRecordIndex : 페이징 SQL의 조건절에 사용되는 시작 rownum. lastRecordIndex : 페이징 SQL의 조건절에 사용되는 마지막 rownum.
	 */
