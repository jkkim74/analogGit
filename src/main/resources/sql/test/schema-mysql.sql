...
create table if not exists PANDORA_CODES (
...
create table if not exists PANDORA_MENU_ACTION_LOG (
	SN int NOT NULL auto_increment,
	USER_ID varchar(50) NOT NULL,
	MENU_ID varchar(50) NOT NULL,
	ACTION_ID varchar(50) NOT NULL,
	SEARCH_COND varchar(200) DEFAULT NULL,
	PTS_MASK varchar(10) DEFAULT NULL,
	PTS_PREFIX varchar(50) DEFAULT NULL,
	ACTION_TIME DATETIME DEFAULT CURRENT_TIMESTAMP,
	PRIMARY KEY (SN)
);

CREATE TABLE IF NOT EXISTS PASS_CHECK (
  USERNAME VARCHAR(50) NOT NULL PRIMARY KEY,
  FAIL_CNT TINYINT
);