...
insert into users(username, password, enabled, pts_username, create_dttm, begin_dttm) values('1001085', 'user5', 1, 'co23835', '20160801090000', '20160801090000');
...
insert into authorities(username, authority, masking_yn) values('1001085', 'ROLE_USER', 1);
...
insert into menu_access(username, menu_id) values('1001085', 'PAN0107');
...
insert into SINGLE_REQUEST_PROGRESS (SN,USERNAME,MEMBER_ID,EXTRACT_TARGET,EXTRACT_COND,PERIOD_TYPE,PERIOD_FROM,PERIOD_TO,STATUS) values('999999', '1001085', '101700393', 'tr','t','sale_dt','20100101','20170314','PROCESSING');
