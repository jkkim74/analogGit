...
CREATE TABLE IF NOT EXISTS "MART_EXTNCT_MBR_NOTI_MST" (
	"BASE_YM" VARCHAR2(6 BYTE),
	"MBR_ID" VARCHAR2(20 BYTE),
	"UNITED_ID" VARCHAR2(14 BYTE),
	"EXTNCT_MBR_FG_CD" VARCHAR2(2 BYTE),
	"MBR_KOR_NM" VARCHAR2(100 BYTE),
	"EMAIL_ADDR" VARCHAR2(200 BYTE),
	"CLPHN_NO" VARCHAR2(20 BYTE),
	"CLPHN_CORCT_FG_CD" VARCHAR2(1 BYTE),
	"JOBP_TEL_NO" VARCHAR2(20 BYTE),
	"HOME_TEL_NO" VARCHAR2(20 BYTE),
	"AVL_PNT" VARCHAR2(13 BYTE),
	"EXTNCT_OBJ_DT" VARCHAR2(8 BYTE),
	"EMAIL_ADDR_CORCT_YN" VARCHAR2(1 BYTE),
	"EMAIL_ADDR_DUP_YN" VARCHAR2(1 BYTE),
	"LD_DTTM" VARCHAR2(14 BYTE),
	"MART_UPD_DTTM" VARCHAR2(14 BYTE),
	"SMS_SND_YN" VARCHAR2(1 BYTE),
	"SMS_SND_FG_CD" VARCHAR2(10 BYTE)
);

CREATE TABLE IF NOT EXISTS "MART_EXTNCT_MBR_FG_CD_MST" (
	"EXTNCT_MBR_FG_CD" VARCHAR2(10 BYTE),
	"EXTNCT_MBR_FG_NM" VARCHAR2(10 BYTE),
	"MBR_FG_NM" VARCHAR2(10 BYTE)
);


CREATE TABLE IF NOT EXISTS "MART_INDIV_MBR_MST" (
  "MBR_ID" VARCHAR2(50 BYTE),
  "UNITED_ID" VARCHAR2(50 BYTE),
  "EMAIL_ADDR" VARCHAR2(50 BYTE),
  "EMAIL_ADDR_DUP_YN" VARCHAR2(50 BYTE),
  "MART_UPD_DTTM" VARCHAR2(50 BYTE)
);
